...
public class Constants {
    ...
    public static final String V_CENTER_URL = "-vCenterUrl";
    ...
    public static final String RESTORE_SNAPSHOT_ACTION = "restore";
    ...
    public static final int START_STOP_MAX_WAIT_IN_MINUTES = 20;
    public static final int OS_CUSTOMIZATION_MAX_WAIT_IN_MINUTES = 30;
    public static final int NETWORK_DISCOVERY_TIME_OUT_IN_MINUTES = 20;
    public static final int NETWORK_DISCOVERY_POLLING_INTERVAL_IN_SECONDS = 30;
